...
def apply_pw_distance_metric_w_multiprocessing(sequences,
    ...
    By Default, a distance wrapper function is be generated by
    pairwise.function_factory() given a recognized string is provided to the
    metric arg ("nw", "hamming", or "bradley").

    Further flexibility exists even with a defaults
    ...
    For instance the following function could be supplied if metric must be set to 'custom.'
